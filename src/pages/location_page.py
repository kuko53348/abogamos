    ...
    def __init__(self, page: object = None, content: object = None) -> None:
        ...
        self.content = ft.Column(
              ...
              controls=[
                ...
                # on_click = lambda tmp_widget: print(tmp_widget.controls),
                # on_hover = lambda tmp_widget: print(tmp_widget.controls),
                # on_long_press = lambda tmp_widget: print(tmp_widget.controls),
                ),
                ft.Container(
                    padding=ft.padding.only(left=8, top=8, right=8, bottom=8),
                    border_radius=ft.border_radius.all(18),
                    border = ft.border.all(width = 2, color = ft.Colors.with_opacity(opacity=0.5,color=ft.Colors("white")),),
                    bgcolor=ft.Colors.with_opacity(opacity=0.98,color=ft.Colors.GREY_900),
                      shadow=ft.BoxShadow(
                          spread_radius=1,
                          blur_radius=15,
